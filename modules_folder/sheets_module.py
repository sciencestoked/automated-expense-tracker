...
def upload_csv_to_sheet(sheets_client, spreadsheet_name, csv_file_path, sheet_name="Sheet1"):
    ...
    try:
        ...
        print(f"Data to upload (first 5 rows): {data[:5]}")  # Print first 5 rows of data
        ...
        sheet.update([df.columns.values.tolist()] + data)  # First row is header, then data
        
        print(f"Successfully uploaded the CSV data to {spreadsheet_name} - {sheet_name}.")
